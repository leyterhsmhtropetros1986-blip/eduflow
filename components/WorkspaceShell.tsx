...
import { 
  ...
  UserCircle, FileText, Bell, Search, Bot, Database, Activity
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0b0e14] flex text-slate-200">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="sticky top-0 bg-[#1e2330]/80 backdrop-blur-md border-b border-slate-800 px-10 py-6 flex items-center justify-between z-10 print:hidden">
          <div>
