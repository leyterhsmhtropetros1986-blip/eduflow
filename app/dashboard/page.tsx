...
export default function DashboardPage() {
  ...
  const [totalCoursesCount, setTotalCoursesCount] = useState(8); // Ασφαλές fallback state
  ...
  // --- DATA HYDRATION ---
  useEffect(() => {
    // Εκτελείται ΜΟΝΟ στον browser - 100% ασφαλές για localStorage
    ...
    <WorkspaceShell title="EduFlow Operations" description="Κεντρικός έλεγχος, AI insights και διαχείριση πόρων εκπαιδευτηρίου σε πραγματικό χρόνο.">
      ...
      <div className="px-6 space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          ...
          {/* LEFT/CENTER WIDGETS COLUMN */}
          <div className="xl:col-span-3 space-y-6">
            
            {/* 4. TODAY'S TIMELINE & 16. CALENDAR WIDGET */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* 12. PIE CHART EQUIVALENT (PROGRESS DISTRIBUTION) */}
          ...
          <div className="xl:col-span-1 space-y-6">
            ...
            <div className="bg-[#1e2330] p-5 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <div className="bg-[#0b0e14] p-4 rounded-xl border border-slate-800 text-center space-y-3">
                ...
                <p className="text-slate-500 text-[10px] leading-normal">Όλες οι αναθέσεις ωρών είναι έγκυρες.</p>
            ...
            <div className="bg-gradient-to-b from-[#24213d] to-[#1e2330] p-5 rounded-3xl border border-indigo-500/20 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-2.5 text-[10px] text-slate-300">
                <div className="bg-[#0b0e14]/60 p-2.5 rounded-xl border border-slate-800/80">
                  💡 <span className="text-indigo-300 font-bold">Πρόταση:</span> Το τμήμα <span className="text-white font-bold">Β1</span> πλησιάζει το μέγιστο όριο. Προτείνεται άνοιγμα παρακλάδου.
                </div>
                <div className="bg-[#0b0e14]/60 p-2.5 rounded-xl border border-slate-800/80">
                  🔍 <span className="text-amber-300 font-bold">Κενό:</span> Εντοπίστηκε διαθέσιμη αίθουσα (Αίθουσα 3) Παρασκευές 16:00-18:00.
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#1e2330] p-5 rounded-3xl border border-slate-800 shadow-xl">
              ...
              <div className="space-y-2 text-[10px] font-medium text-slate-400">
                ...
                <div className="border-l-2 border-slate-700 pl-2 py-0.5">
                  ...
                  <p className="text-slate-500 font-mono text-[9px]">Σήμερα 20:35 • Build Success</p>
                </div>
              </div>
            </div>
...
function SystemStatusRow({ label, status, color }: { label: string; status: string; color: string; }) {
  return (
    <div className="flex justify-between items-center bg-[#0b0e14] px-3 py-1.5 rounded-lg border border-slate-900/60">
      ...
      <span className={`${color} font-bold flex items-center gap-1`}><span className="w-1.5 h-1.5 rounded-full bg-current"></span>{status}</span>
    </div>
  );
}